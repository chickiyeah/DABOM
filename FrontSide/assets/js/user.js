...
async function cookieSave(json) {
     if (is_checked()) {
       ...
       // 액세스 토큰 쿠키 설정
        document.cookie = "access_token=" + json.access_token + "; expires=" + expires.toUTCString() + "; path=/ ;max-age=604800;";
              
        // 리프레시 토큰 쿠키 설정
        document.cookie = "refresh_token=" + json.refresh_token + "; expires=" + expires.toUTCString() + "; path=/max-age=604800;";
    }
}
